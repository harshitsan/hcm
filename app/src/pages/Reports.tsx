...
import {
  ...
  LineChart as LineChartIcon, Table2, Filter, ShieldCheck,
} from 'lucide-react'
import {
...
export default function Reports() {
  ...
  const run = (name: string) => push({ title: `Running “${name}”`, tone: 'info' })
        ...
        actions={
          <>
            <Segmented
              ...
              onChange={setRange}
            />
            <Button onClick={() => push({ title: 'New report builder', tone: 'primary' })}>
          ...
          {reports.map((r) => {
            ...
            return (
              ...
              >
                ...
                <Button size="sm" variant="ghost" onClick={() => run(r.name)}>
        ...
        <ChartCard title="Headcount by department" badge={<Badge tone="primary">{company.employees} total</Badge>}>
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={headcountByDept} margin={{ top: 8, right: 8, bottom: 0, left: -16 }}>
              ...
              <Bar dataKey="value" name="Employees" fill="#4f46e5" radius={[6, 6, 0, 0]} maxBarSize={42} />
            </BarChart>
          </ResponsiveContainer>
        </ChartCard>
        ...
        <ChartCard title="Headcount trend" badge={<Badge tone="success">+16% YoY</Badge>}>
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={trendData} margin={{ top: 8, right: 8, bottom: 0, left: -16 }}>
              ...
              <Area type="monotone" dataKey="value" name="Headcount" stroke="#10b981" strokeWidth={2} fill="url(#rep-hc)" />
            </AreaChart>
          </ResponsiveContainer>
        </ChartCard>
        ...
        <ChartCard title="Leave taken by month" badge={<Badge tone="info">Annual + sick</Badge>}>
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={leaveData} margin={{ top: 8, right: 8, bottom: 0, left: -16 }}>
              ...
              <Bar dataKey="annual" name="Annual" stackId="l" fill="#2563eb" maxBarSize={36} />
              <Bar dataKey="sick" name="Sick" stackId="l" fill="#d97706" radius={[6, 6, 0, 0]} maxBarSize={36} />
            </BarChart>
          </ResponsiveContainer>
        </ChartCard>
