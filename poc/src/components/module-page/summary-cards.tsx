...
/**
 * Canonical count cards shown above module tables (promoted from
 * workflows/components/summary-cards.tsx — the scaffold-kit reference).
 * Every module renders this shared version; local forks are re-export shims.
 */
